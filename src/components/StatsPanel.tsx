    ...
    return (
      <div className="animate-fade-in space-y-3">
        <div className="flex items-center">
          <BarChart2 className="w-4 h-4 mr-2 text-indigo-500 dark:text-indigo-400" />
        ...
        <div className="space-y-2">
          ...
          <div className="pt-1">
            ...
            <div className="mt-1 space-y-0.5 text-xs text-neutral-500 dark:text-neutral-400">
              <div className="flex justify-between">
                <span>Base tokens (after transformations):</span>
                <span className="font-medium">
                  {metrics.rawTokens.toLocaleString()} tokens
                </span>
              </div>
              <div className="flex justify-between">
                <span>
              ...
              {metrics.tokenSavings > 0 && (
                <div className="flex justify-between text-emerald-600 dark:text-emerald-400">
                  ...
                  <span className="font-bold">
                    {metrics.tokenSavings.toLocaleString()} tokens (
          ...
          {/* Token Breakdown Section - Collapsible */}
          <div className="space-y-1">
            <button
              onClick={() => setShowBreakdown(!showBreakdown)}
              className="flex items-center justify-between w-full text-xs font-semibold uppercase tracking-wide text-neutral-500 dark:text-neutral-400 hover:text-neutral-700 dark:hover:text-neutral-300 transition-colors"
            >
            ...
            {showBreakdown && (
              <div className="p-2 rounded-lg bg-neutral-50 dark:bg-neutral-800/40 ring-1 ring-neutral-200 dark:ring-neutral-700/50">
          ...
          {metrics.budgetStatus !== 'safe' && (
            <div className="mt-1 flex items-start space-x-2 text-xs text-red-600 dark:text-red-400 p-2 rounded-md bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-500/30">
          ...
          {metrics.budgetStatus === 'safe' && totalSize > 0 && (
            <div className="mt-1 flex items-start space-x-2 text-xs text-emerald-700 dark:text-emerald-300 p-2 rounded-md bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-500/30">
              <CheckSquare className="w-4 h-4 flex-shrink-0 mt-0.5 text-emerald-600 dark:text-emerald-400" />
              <span className="leading-snug">{metrics.budgetMessage}</span>
            </div>
          )}

          <div className="flex flex-col gap-2 mt-2 text-xs text-neutral-600 dark:text-neutral-400">
            <div className="rounded-lg bg-neutral-100 dark:bg-neutral-800/40 px-2 py-1.5">
              ...
              <p className="text-[10px]">of {metrics.totalCount} scanned</p>
            </div>
            <div className="rounded-lg bg-neutral-100 dark:bg-neutral-800/40 px-2 py-1.5">
              <p className="text-[10px] uppercase tracking-wide text-neutral-500 dark:text-neutral-500">
                Smart Optimizer
              </p>
              <p className="text-[10px] text-neutral-600 dark:text-neutral-300 leading-snug">
            ...
            {metrics.templateTokens > 0 && (
              <div className="rounded-lg bg-blue-50 dark:bg-blue-900/20 px-2 py-1.5 border border-blue-200 dark:border-blue-800">
                <p className="text-[10px] uppercase tracking-wide text-blue-600 dark:text-blue-400">
                  Template Tokens
                </p>
            ...
            {metrics.context7Tokens > 0 && (
              <div className="rounded-lg bg-purple-50 dark:bg-purple-900/20 px-2 py-1.5 border border-purple-200 dark:border-purple-800">
                <p className="text-[10px] uppercase tracking-wide text-purple-600 dark:text-purple-400">
                  Ref Docs Tokens
                </p>
            ...
            {metrics.transformationSavings > 0 && (
              <div className="rounded-lg bg-emerald-50 dark:bg-emerald-900/20 px-2 py-1.5 border border-emerald-200 dark:border-emerald-800">
            ...
            <div className="mt-4 space-y-2">
              ...
              <div className="space-y-1.5">
                {metrics.topFiles.map((file) => (
                  <div
                    key={file.path}
                    className="flex flex-col rounded-md bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 px-3 py-2 text-sm gap-1"
                  >
                    ...
                    <div className="flex items-center space-x-2 text-[10px] text-neutral-500 dark:text-neutral-400 pl-6">
